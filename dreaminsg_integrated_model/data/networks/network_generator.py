...
def generate_watern(file_name):
    ...
    #Add reservoir
    wn.add_reservoir('W_R1', base_head=15, head_pattern=None,
                     coordinates=(0, 500))

    #Add tank
    wn.add_tank('W_T1', elevation=10, init_level=3, min_level=0, max_level=5,
                diameter=15, coordinates=(400, 500))

    #Add juntions
    wn.add_junction('W_J1', base_demand=0.005, demand_pattern='pd_1',
                    elevation=20, coordinates=(200, 600))
    wn.add_junction('W_J2', base_demand=0.005, demand_pattern='pd_1',
                    elevation=0, coordinates=(300, 450))
    wn.add_junction('W_J3', base_demand=0.002, demand_pattern='pd_1',
                    elevation=0, coordinates=(200, 300))
    wn.add_junction('W_J4', base_demand=0.008, demand_pattern='pd_1',
                    elevation=0, coordinates=(300, 300))
    wn.add_junction('W_J5', base_demand=0.050, demand_pattern='pd_1',
                    elevation=0, coordinates=(500, 300))
    wn.add_junction('W_J6', base_demand=0.020, demand_pattern='pd_1',
                    elevation=1, coordinates=(200, 0))
    wn.add_junction('W_J7', base_demand=0.030, demand_pattern='pd_1',
                    elevation=0, coordinates=(500, 0))

    #Add pipes
    wn.add_pipe('W_P3', 'W_J1', 'W_J2', length=1000, diameter=0.4,
                roughness=100, minor_loss=0, status='OPEN')
    wn.add_pipe('W_P4', 'W_J2', 'W_T1', length=1000, diameter=0.2,
                roughness=100, minor_loss=0, status='OPEN')
    wn.add_pipe('W_P5', 'W_J1', 'W_J3', length=1000, diameter=0.4,
                roughness=100, minor_loss=0, status='OPEN')
    wn.add_pipe('W_P6', 'W_J2', 'W_J4', length=1000, diameter=0.4,
                roughness=100, minor_loss=0, status='OPEN')
    wn.add_pipe('W_P7', 'W_J3', 'W_J4', length=1000, diameter=0.4,
                roughness=100, minor_loss=0, status='OPEN')
    wn.add_pipe('W_P8', 'W_J4', 'W_J5', length=1000, diameter=0.4,
                roughness=100, minor_loss=0, status='OPEN')
    wn.add_pipe('W_P9', 'W_J3', 'W_J6', length=1000, diameter=0.4,
                roughness=100, minor_loss=0, status='OPEN')
    wn.add_pipe('W_P10', 'W_J5', 'W_J7', length=1000, diameter=0.4,
                roughness=100, minor_loss=0, status='OPEN')
    wn.add_pipe('W_P11', 'W_J6', 'W_J7', length=1000, diameter=0.4,
                roughness=100, minor_loss=0, status='OPEN')

    #Add pump
    wn.add_pump('W_WP1', 'W_R1', 'W_J1',
                pump_type='POWER', pump_parameter=50, speed=1, pattern=None)
    #plot
...
def generate_powern(file_name):
    ...
    line1 = pp.create_line(
        pn, bus1, bus2, length_km=5, std_type='N2XS(FL)2Y 1x120 RM/35 64/110 kV', name="P_L1")
    ...
    line4 = pp.create_line(
        pn, bus1, bus6, length_km=5, std_type='N2XS(FL)2Y 1x120 RM/35 64/110 kV', name="P_L4")
    line5 = pp.create_line(
        pn, bus6, bus7, length_km=5, std_type='N2XS(FL)2Y 1x120 RM/35 64/110 kV', name="P_L5")
    #print(pn.line)
