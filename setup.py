...
setup(
    ...
    entry_points={
        'console_scripts': [
            'dreaminsg_integrated_model=dreaminsg_integrated_model.cli:main',
        ],
    },
    ...
    keywords='dreaminsg_integrated_model',
    name='dreaminsg_integrated_model',
    packages=find_packages(include=['dreaminsg_integrated_model', 'dreaminsg_integrated_model.*']),
